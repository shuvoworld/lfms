    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-partnerPayments">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.payment.fields.partner') }}
                            </th>
                            <th>
...
@endcan
  ...
  let table = $('.datatable-partnerPayments:not(.ajaxTable)').DataTable({ buttons: dtButtons })
